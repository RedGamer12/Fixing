return function(Type, PatchName)
    ...
    -- // Vars
    local PatchFormat = "https://raw.githubusercontent.com/RedGamer12/Fixing/main/GamePatches/%s/%s.lua"
    ...
    if (not Success) then
        local ModuleFormat = "https://raw.githubusercontent.com/RedGamer12/Fixing/main/%s.lua"
